...
router.get('/:refundNumber', controller.query_item, controller.common_query);
//환불상품 조회 (PRIVATE)//req.param('id') => ?id='anstnsp'&pwd='ff' , req.params.ordCd => :ordCd
router.get('/private/:refundNumber', controller.query_item_with_private, controller.common_query);
//리치쿼리 
